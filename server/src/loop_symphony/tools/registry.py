...
from loop_symphony.tools.base import Tool
...
class ToolRegistry:
    ...
    Instruments declare required/optional capabilities (Phase B).
    The registry resolves those to concrete tool instances.
    """
    ...
    def register(self, tool: Tool) -> None:
        ...
        Args:
            tool: A tool satisfying the Tool protocol.
    ...
    def get_by_capability(self, capability: str) -> Tool | None:
        """Return the first registered tool with the given capability."""
    ...
    def resolve(
        ...
        Args:
            ...
            optional: Capabilities that are used if available.

        Returns:
            Dict mapping capability name to tool instance.

        Raises:
            CapabilityError: If any required capability has no registered tool.
        """
